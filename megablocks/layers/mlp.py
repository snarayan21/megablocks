...
def create_moe_expert_weights(args : Arguments,
    ...
    # If using int8 communcation, this should be initialized to int8.
    # Ignore PyTorch RuntimeError about integer tensors not having gradients.
    master_weights = torch.empty(
        num_experts, ffn_hidden_size, hidden_size,
        device=args.device,
        dtype=torch.float8_e4m3fn if args.parametrize and args.int8_comms else common.dtype(args))
...
class MLP(torch.nn.Module):
    ...
    def __init__(self, args : Arguments):
        ...
        # If using int8 communication, parameters should have dtype int8 and does not require grad
